...
# 读取新的方法实现
with open('former3d/stream_sdfformer_integrated_backup_before_fusion.py', 'r', encoding='utf-8') as f:
...
# 构建新文件
new_lines = lines[:700] + [new_fusion_method] + lines[961:]

# 保存
with open('former3d/stream_sdfformer_integrated.py', 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("✓ 成功替换_apply_stream_fusion方法")
