...
1. **Required:** Before developing any specific function, evaluate the input and output, expected behavior, and develop test cases; place all test cases in the `tests` directory;
